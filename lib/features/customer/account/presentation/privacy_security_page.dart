        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              const Divider(height: 1, indent: 56),
              _menuRow(Icons.lock_outline, 'Privacy & security', 'Sessions and secure data', appMuted, null),
              const Divider(height: 1, indent: 56),
              _menuRow(Icons.help_outline, 'Help & support', 'Contact Sahajomy', appMuted, () => context.push('/customer/support')),
            ],
          ),
        ),
      ],
