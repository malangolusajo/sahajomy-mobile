...
class _LiveWorkflowPageState extends ConsumerState<LiveWorkflowPage> {
  ...
  Future<Object> _load() =>
      ref.read(workflowApiRepositoryProvider).load(widget.endpoint);
  Future<void> _reload() async {
    ...
    try {
      ...
      /* Render the contextual error state. */
    }
  }

  @override
  Widget build(BuildContext context) {
    final body = FutureBuilder<Object>(
      future: _result,
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError) {
          return SahajomyMessageState(
            ...
            message: logisticsError(snapshot.error, widget.title.toLowerCase()),
            actionLabel: 'Reload ${widget.title.toLowerCase()}',
            onAction: _reload,
          );
        }
          ...
          child: CustomScrollView(
            ...
            slivers: [
                  ...
                  child: Column(
                    children: [
                      LogisticsIntro(
                        ...
                        description:
                            widget.description ??
                            'Review ${widget.title.toLowerCase()} in your ${widget.role == 'Public' ? 'Sahajomy' : widget.role.toLowerCase()} workspace.',
                      ),
                      if (widget.actionRoute != null &&
              ...
              if (filtered.isEmpty)
                SliverFillRemaining(
                  hasScrollBody: false,
                  child: SahajomyMessageState(
                    icon: Icons.inventory_2_outlined,
                    message: _query.isEmpty
                        ? 'No ${widget.title.toLowerCase()} available yet.'
                ...
                SliverPadding(
                  ...
                  sliver: SliverList.separated(
                    ...
                    itemBuilder: (_, index) => LogisticsRecordTile(
