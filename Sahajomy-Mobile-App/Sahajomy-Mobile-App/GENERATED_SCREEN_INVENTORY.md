...
| Public | `/staff-invitation` | [public-staff-invitation.html](html-previews/public-staff-invitation.html) |
...
| Public | `/sea-freight-africa` | [public-sea-freight-africa.html](html-previews/public-sea-freight-africa.html) |
| Public | `/air-cargo-africa` | [public-air-cargo-africa.html](html-previews/public-air-cargo-africa.html) |
| Public | `/china-sourcing-africa` | [public-china-sourcing-africa.html](html-previews/public-china-sourcing-africa.html) |
...
| Public | `/cargo-operator/register` | [public-cargo-company-registration.html](html-previews/public-cargo-company-registration.html) |
| Shared | `/label/air/:bookingId` | [shared-air-shipping-label.html](html-previews/shared-air-shipping-label.html) |
| Shared | `/label/sea/:seaBookingId` | [shared-sea-shipping-label.html](html-previews/shared-sea-shipping-label.html) |
| Shared | `/product/:productId` | [shared-product-detail.html](html-previews/shared-product-detail.html) |
| Shared | `/account/workspaces` | [shared-workspace-selection.html](html-previews/shared-workspace-selection.html) |
| Customer | `/customer/sea-bookings` | [customer-sea-bookings.html](html-previews/customer-sea-bookings.html) |
| Customer | `/customer/sea-bookings/:seaBookingId` | [customer-sea-booking-detail.html](html-previews/customer-sea-booking-detail.html) |
...
| Sourcing Agent | `/agent/china-addresses` | [agent-china-addresses.html](html-previews/agent-china-addresses.html) |
...
| Sourcing Agent | `/agent/sea-bookings` | [agent-sea-bookings.html](html-previews/agent-sea-bookings.html) |
...
| Cargo Admin | `/cargo/pending-approval` | [cargo-admin-pending-approval.html](html-previews/cargo-admin-pending-approval.html) |
| Cargo Admin | `/cargo/sea-bookings` | [cargo-admin-sea-bookings.html](html-previews/cargo-admin-sea-bookings.html) |
...
| Cargo Admin | `/cargo/documentationworkspace/customers` | [cargo-admin-documentation-customers.html](html-previews/cargo-admin-documentation-customers.html) |
| Cargo Admin | `/cargo/documentationworkspace/warehouse-automation` | [cargo-admin-warehouse-automation.html](html-previews/cargo-admin-warehouse-automation.html) |
| Cargo Admin | `/cargo/express-air-cargo` | [cargo-admin-express-air-cargo.html](html-previews/cargo-admin-express-air-cargo.html) |
| Cargo Admin | `/cargo/finance` | [cargo-admin-financial-analytics.html](html-previews/cargo-admin-financial-analytics.html) |
| Cargo Admin | `/cargo/settings/staff-branches` | [cargo-admin-staff-branches.html](html-previews/cargo-admin-staff-branches.html) |
| Cargo Admin | `/cargo/settings/billing` | [cargo-admin-billing-usage.html](html-previews/cargo-admin-billing-usage.html) |
...
| Super Admin | `/admin/companies/:companyId` | [super-admin-company-detail.html](html-previews/super-admin-company-detail.html) |
| Super Admin | `/admin/bookings` | [super-admin-bookings.html](html-previews/super-admin-bookings.html) |
| Super Admin | `/admin/subscriptions` | [super-admin-subscriptions.html](html-previews/super-admin-subscriptions.html) |
